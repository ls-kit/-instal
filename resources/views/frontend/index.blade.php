        ...
        <div class="container" data-aos="/fade-right" data-aos-duration="/1000">
            ...
            <div class="owl-carousel service-slider">
                ...
                <div class="item">
                    <div class="category-item">
                        <div class="category-img">
                            <img src="images/services/VETERINARI.jpg" alt="image" class="w-100">
                            <div class="text-overlay">
        ...
        <div class="container">
            ...
            <div class="owl-carousel ecommerce-slide" data-aos="/fade-right" data-aos-duration="1000">
                ...
                <div class="item">
                    <div class="ecommerce-item">
                        <a href="#">
                            <img src="images/ecommerce/PRETTY-LITTLE-THING.png" alt="logo">
                            <h3>PRETTY LITTLE THING</h3>
                        </a>
                    </div>
                </div>
                <div class="item">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4 t-center order-1 order-md-2">
                    ...
                    <h3 class="mobile-caption">Incentrato sulla creazione di un'esperienza cliente realmente semplice.</h3>
